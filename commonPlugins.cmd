...
NDOpenCVConfigure("EDGE1", $(QSIZE), 0, "$(PORT1)", 0, 0, 0)
dbLoadRecords("$(ADCORE)/db/NDPluginBase.template","P=$(PREFIX),R=Edge1:, PORT=EDGE1,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT1),NDARRAY_ADDR=0")
dbLoadRecords("$(ADCORE)/db/NDOpenCV.template",    "P=$(PREFIX),R=Edge1:, PORT=EDGE1,ADDR=0,TIMEOUT=1")
